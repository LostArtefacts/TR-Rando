...
public class TR2OutfitRandomizer : BaseTR2Randomizer
{
    ...
    public override void Randomize(int seed)
    {
        ...
        if (Settings.RemoveRobeDagger)
        {
            ...
            _firstDragonLevel = levels.Find(l => l.Data.Entities.ToList().FindIndex(e => e.TypeID == (short)TR2Type.MarcoBartoli) != -1);
        }
    ...
    internal class OutfitProcessor : AbstractProcessorThread<TR2OutfitRandomizer>
    {
        ...
        private void HideEntities(TR2CombinedLevel level, IEnumerable<TR2Type> entities)
        {
