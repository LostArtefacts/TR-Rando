...
{
    public class TR2LevelProcessor : AbstractLevelProcessor<TR23ScriptedLevel, TR2CombinedLevel>
    {
        ...
        protected override TR2CombinedLevel LoadCombinedLevel(TR23ScriptedLevel scriptedLevel)
        {
