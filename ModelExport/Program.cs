...
class Program
{
    ...
    {
        MassTR1ModelExporter exporter = new MassTR1ModelExporter();
    ...
    {
        MassTR2ModelExporter exporter = new MassTR2ModelExporter();
    ...
    {
        MassTR3ModelExporter exporter = new MassTR3ModelExporter();
