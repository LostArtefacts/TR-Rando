...
public enum TR2Type : uint
{
    ...
    PickupAid                = 268,
    SavegameCrystal_P        = 269,
    LaraExtraSkinTrex        = 270,
    LaraExtraSkinMidas       = 271,
    LaraExtraSkinDagger1     = 272,
    LaraExtraSkinDagger2     = 273,
    LaraHairSwap             = 274,
    SecretOption1            = 275,
    SecretOption2            = 276,
    SecretOption3            = 277,
    ...
    MP5_S_P                  = 293,
    MP5Ammo_S_P              = 294,
    LaraRocketAnim_H         = 295,
    RocketLauncher_M_H       = 296,
    RocketAmmo_M_H           = 297,
    RocketProjectile_H       = 298,
    RocketLauncher_S_P       = 299,
    RocketAmmo_S_P           = 300,
    Shadow_S_H               = 301,
    ...
    Plant3                   = PickupAid,
    Plant4                   = SavegameCrystal_P,
    Plant5                   = LaraExtraSkinTrex,
    Plant6                   = LaraExtraSkinMidas,
    Plant7                   = LaraExtraSkinDagger1,
    Plant8                   = LaraExtraSkinDagger2,
    Plant9                   = LaraHairSwap,
    ...
    Furniture9               = Snowflake_S_H,
    Rock0                    = LaraDeagleAnim_H,
    Rock1                    = Deagle_M_H,
    Rock2                    = DeagleAmmo_M_H,
    Rock3                    = Deagle_S_P,
    Rock4                    = DeagleAmmo_S_P,
    Rock5                    = LaraMP5Anim_H,
    Rock6                    = MP5_M_H,
    Rock7                    = MP5Ammo_M_H,
    Rock8                    = MP5_S_P,
    Rock9                    = MP5Ammo_S_P,
    Architecture0            = LaraRocketAnim_H,
    Architecture1            = RocketLauncher_M_H,
    Architecture2            = RocketAmmo_M_H,
    Architecture3            = RocketProjectile_H,
    Architecture4            = RocketLauncher_S_P,
    Architecture5            = RocketAmmo_S_P,
    Architecture6            = Shadow_S_H,
    Architecture7            = 302,
    Architecture8            = 303,
    Architecture9            = 304,
    Debris0                  = 305,
