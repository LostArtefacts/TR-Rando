...
public static class TR1TypeUtilities
{
    ...
    public static string GetName(TR1Type type)
    {
        ...
        return type switch
        {
            ...
            TR1Type.LaraDeagleAnim_H => "LaraDeagleAnim_H",
            TR1Type.Deagle_M_H => "Deagle_M_H",
            TR1Type.DeagleAmmo_M_H => "DeagleAmmo_M_H",
            TR1Type.Snowflake_S_H => "Snowflake_S_H",
            TR1Type.Deagle_S_P => "Deagle_S_P",
            TR1Type.DeagleAmmo_S_P => "DeagleAmmo_S_P",
            TR1Type.LaraMP5Anim_H => "LaraMP5Anim_H",
            TR1Type.MP5_M_H => "MP5_M_H",
            TR1Type.MP5Ammo_M_H => "MP5Ammo_M_H",
            TR1Type.MP5_S_P => "MP5_S_P",
            TR1Type.MP5Ammo_S_P => "MP5Ammo_S_P",
            TR1Type.LaraRocketAnim_H => "LaraRocketAnim_H",
            TR1Type.RocketLauncher_M_H => "RocketLauncher_M_H",
            TR1Type.RocketAmmo_M_H => "RocketAmmo_M_H",
            TR1Type.RocketProjectile_H => "RocketProjectile_H",
            TR1Type.RocketLauncher_S_P => "RocketLauncher_S_P",
            TR1Type.RocketAmmo_S_P => "RocketAmmo_S_P",
            _ => type.ToString(),
        };
    }
