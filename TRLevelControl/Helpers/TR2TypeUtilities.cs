...
public static class TR2TypeUtilities
{
    ...
    public static string GetName(TR2Type type)
    {
        ...
        return type switch
        {
            ...
            TR2Type.Snowflake_S_H => "Snowflake_S_H",
            TR2Type.LaraDeagleAnim_H => "LaraDeagleAnim_H",
            TR2Type.Deagle_M_H => "Deagle_M_H",
            TR2Type.DeagleAmmo_M_H => "DeagleAmmo_M_H",
            TR2Type.Deagle_S_P => "Deagle_S_P",
            TR2Type.DeagleAmmo_S_P => "DeagleAmmo_S_P",
            TR2Type.LaraMP5Anim_H => "LaraMP5Anim_H",
            TR2Type.MP5_M_H => "MP5_M_H",
            TR2Type.MP5Ammo_M_H => "MP5Ammo_M_H",
            TR2Type.MP5_S_P => "MP5_S_P",
            TR2Type.MP5Ammo_S_P => "MP5Ammo_S_P",
            TR2Type.LaraRocketAnim_H => "LaraRocketAnim_H",
            TR2Type.RocketLauncher_M_H => "RocketLauncher_M_H",
            TR2Type.RocketAmmo_M_H => "RocketAmmo_M_H",
            TR2Type.RocketProjectile_H => "RocketProjectile_H",
            TR2Type.RocketLauncher_S_P => "RocketLauncher_S_P",
            TR2Type.RocketAmmo_S_P => "RocketAmmo_S_P",
            _ => type.ToString(),
        };
    }
