...
namespace TREnvironmentEditor.Model.Types
{
    public class EMCopyRoomFunction : BaseEMFunction
    {
        ...
        public override void ApplyToLevel(TR2Level level)
        {
            ...
            byte xmax = (byte)((newRoom.Info.X / SectorSize) + (newRoom.SectorList.Length / newRoom.NumZSectors));
            byte zmax = (byte)((newRoom.Info.Z / SectorSize) + (newRoom.SectorList.Length % newRoom.NumZSectors));
