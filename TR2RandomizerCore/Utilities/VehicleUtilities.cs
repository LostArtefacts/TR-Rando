...
namespace TR2RandomizerCore.Utilities
{
    public static class VehicleUtilities
    {
        ...
        {
            _allVehicleLocations = JsonConvert.DeserializeObject<Dictionary<string, Dictionary<TR2Entities, List<Location>>>>(File.ReadAllText(@"Resources\vehicle_locations.json"));
        }
