...
namespace TR2RandomizerCore.Zones
{
    class ZonedLocationCollection
    {
        ...
        public void PopulateZones(string lvl, List<Location> locations, ZonePopulationMethod popMethod)
        {
            Dictionary<int, List<int>> ZoneMap = JsonConvert.DeserializeObject<Dictionary<int, List<int>>>(File.ReadAllText(@"Resources\Zones\" + lvl + "-Zones.json"));
